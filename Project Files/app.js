...
var uri = "mongodb+srv://sohailaso:conanco@cluster0.k5asmg8.mongodb.net/?retryWrites=true&w=majority"
...
app.post("/register",async function (req, res) {
  ...
  var user = await client.db('firstdb').collection('firstcollection').findOne({username:x,password:y});
